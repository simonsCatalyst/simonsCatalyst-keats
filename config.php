...
$THEME->sheets = array('custom', 'profilebar', 'fonts', 'font-awesome', 'yellowTheme', 'orangeTheme', 'highvisTheme', 'fontBig', 'settings');
...
$THEME->layouts = array(
    ...
    'mydashboard' => array(
        'file' => 'columns3.php',
        'regions' => array('side-pre', 'side-post' , 'overview'),
        'defaultregion' => 'side-pre',
        'options' => array('langmenu'=>true),
    ),
    // My public page.
...
$THEME->csspostprocess = 'keats_process_css';
